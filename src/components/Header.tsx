  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
        ...
        >
          <a href="#servicios" className="transition-colors hover:opacity-70">
            Servicios
          </a>
          <a
            href="#adiestramiento"
          ...
          <a href="#cursos" className="transition-colors hover:opacity-70">
            Cursos
          </a>
          <a href="#contacto" className="transition-colors hover:opacity-70">
            Contacto
          </a>
        </div>
