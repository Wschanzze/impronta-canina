...
const StickyCTABar: React.FC<StickyCTABarProps> = ({ triggerAfterCard }) => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 sticky-cta ${visible ? 'visible' : ''}`}
    >
      <div
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs" style={{ color: 'rgba(26,26,26,0.65)' }}>Adiestramiento · Asesoramiento · Cursos · Paseos · Traslados</p>
          </div>
        </div>
