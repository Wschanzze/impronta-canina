...
const BlueprintCTA: React.FC = () => {
  ...
  return (
    <section id="contacto" className="relative w-full min-h-[60vh] flex items-center justify-center py-12 md:py-16 px-4 md:px-8 overflow-hidden">
      {/* Translucent Background Image with Zoom Pulse Animation */}
      <motion.div 
      ...
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-tangerine/15 blur-[90px] pointer-events-none z-0 animate-pulse" 
          ...
          >
            ...
            <div className="md:col-span-2 mt-2">
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="w-full flex items-center justify-center gap-2.5 text-white font-bold text-base px-6 py-3 rounded-xl shadow-lg shadow-tangerine/20 transition-all disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
                style={{ background: 'var(--tangerine)' }}
              >
                <svg className="w-5 h-5 animate-bounce" viewBox="0 0 24 24" fill="currentColor" style={{ animationDuration: '2.5s' }}>
